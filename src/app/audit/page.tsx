...
export default async function AuditPage() {
    ...
    try {
        ...
        if (e?.code === 'P2021') {
            return (
                <div className="flex flex-col h-screen bg-black text-green-500 font-mono p-8 justify-center items-center">
                    <div className="animate-pulse">
                        <h1 className="text-2xl mb-2">&gt; SYSTEM_INITIALIZING...</h1>
                        <p className="opacity-50 text-sm">Waiting for database schema migration.</p>
                    </div>
                </div>
            )
        }
